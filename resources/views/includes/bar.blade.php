...
<nav class="navbar navbar-expand-lg mb-4 topbar bg-dark" data-bs-theme="dark">
  <div class="container-fluid">
    ...
    <a class="navbar-brand" href="{{ route('home') }}"><img src="https://res.cloudinary.com/dzcmxfodx/image/upload/w_20/h_20/q_auto/f_auto/v1750432107/logo_hq0ose.png" loading="lazy" class="d-inline-block align-text-top" alt="Inicio" width="20" height="20"> Administrador</a>
