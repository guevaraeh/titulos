...
<html lang="en" class="h-100" data-bs-theme="auto"> 
    <head>
        ...
        <link rel="shortcut icon" href="https://res.cloudinary.com/dzcmxfodx/image/upload/w_20/h_20/q_auto/f_auto/v1750432107/logo_hq0ose.png" />

        <title>Actas de Titulación</title>
        
        <link rel="canonical" href="https://getbootstrap.com/docs/5.3/examples/cover/">
        <script src="{{ asset('/libraries/cover/color-modes.js') }}"></script>
        <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/css/bootstrap.min.css" integrity="sha384-QWTKZyjpPEjISv5WaRU9OFeRpok6YctnYmDr5pNlyT2bRjXh0JMhjY6hW+ALEwIH" crossorigin="anonymous">
        <link href="{{ asset('/libraries/cover/cover.css') }}" rel="stylesheet">
        <style>
    ...
    <body class="d-flex h-100 text-center text-bg-dark"> 
        ...
        <div class="dropdown position-fixed bottom-0 end-0 mb-3 me-3 bd-mode-toggle"> 
            ...
            <ul class="dropdown-menu dropdown-menu-end shadow" aria-labelledby="bd-theme-text"> 
                <li> 
                    ...
                    </button> </li> <li> <button type="button" class="dropdown-item d-flex align-items-center" data-bs-theme-value="dark" aria-pressed="false"> <svg class="bi me-2 opacity-50" aria-hidden="true"><use href="#moon-stars-fill"></use></svg>
                        Dark
                        <svg class="bi ms-auto d-none" aria-hidden="true"><use href="#check2"></use></svg> 
                    </button> 
                </li> 
        ...
        <div class="container d-flex w-100 h-100 p-3 mx-auto flex-column"> 
            <header class="mb-auto"> 
                <div> 
                    <h3 class="float-md-start mb-0">Instituto Pedro P. Diaz</h3> 
            ...
            <main class="px-3"> 
                <img src="https://res.cloudinary.com/dzcmxfodx/image/upload/q_auto/f_auto/v1750432107/logo_hq0ose.png" alt="Logo" class="mb-1 flex items-center justify-center rounded-md" />
                <h1>Actas de Titulación</h1> 
                <p class="lead">Plataforma de generación de actas.</p> 
                <p class="lead"> 
                    <a href="{{ route('titulation_certificate.create_fast') }}" class="btn btn-lg btn-light fw-bold border-white bg-white">Hacer Acta</a> 
                    <a href="{{ route('titulation_certificate.generate_pdf_empty') }}" class="btn btn-lg btn-light fw-bold border-white bg-white" target="_blank">Acta vacía</a> 
                    <a href="{{ route('titulation_certificate.search_certificates') }}" class="btn btn-lg btn-light fw-bold border-white bg-white">Buscar Acta</a> 
                </p> 
            </main> 
